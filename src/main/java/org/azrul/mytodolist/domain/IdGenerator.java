...
@Entity
@Indexed
@Table(name = "ID_GENERATOR",schema = "TODO1")
public class IdGenerator implements Generator<Long>,Serializable {
    ...
    public String toString() {
        return "org.azrul.loanorigsystem.model.IdGenerator[ id=" + id + " ]";
    }
